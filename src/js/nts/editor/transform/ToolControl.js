...
export class ToolControl extends PIXI.Sprite {
    ...
    get globalPoint() {
        return this.target.worldTransform.apply(this._localPoint);
    }
    ...
    getScaleCursor() {
        switch (this.cursorIndex) {
            case 0: // 0-45, TOP_CENTER
                return 'ns-resize';
            case 1: // 45-90, TOP_RIGHT
                return 'nesw-resize';
            case 2: // 90-135, MIDDLE_RIGHT
                return 'ew-resize';
            case 3: // 135-180, BOTTOM_RIGHT
                return 'nwse-resize';
            case 4: // 180-225, BOTTOM_CENTER
                return 'ns-resize';
            case 5: // 225-270, BOTTOM_LEFT
                return 'nesw-resize';
            case 6: // 270-315, MIDDLE_LEFT
                return 'ew-resize';
            case 7: // 315-360, TOP_LEFT
                return 'nwse-resize';
        }
    }
